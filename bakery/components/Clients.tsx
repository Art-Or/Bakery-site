  ...
  return (
    ...
    >
      ...
      <div 
        data-aos="zoom-in" 
        data-aos-delay="200"
        className='w-full grid lg:grid-cols-4 grid-cols-1 justify-center items-center lg:gap-8 gap-20'
      >
        {
          clients.map((item, index) => (
            <div 
              key={index}
              className='flex flex-col justify-center items-start gap-4 bg-orange-600 p-10 h-[350px] rounded-xl relative'
            >
              <div 
                id="icon-box"
                className='bg-white p-6 rounded-full text-orange-600 absolute -top-10'
              >
