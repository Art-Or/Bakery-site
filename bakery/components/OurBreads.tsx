...
const OurBreads = () => {
  ...
  return (
    <section 
      id="breads" 
      className='
        w-full flex flex-col justify-center items-center gap-10 bg-cover 
        h-fit py-20 lg:px-20 px-10 bg-center
       '
        ...
        className='w-full grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-6'>
          {ourbreads.map((item, index) => (
            ...
            >
              ...
              <button className='
                border-2 border-black rounded-full px-8 py-2 uppercase text-sm 
                font-semibold transform hover:scale-110 transition-transform 
